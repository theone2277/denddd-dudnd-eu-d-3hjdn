...
module.exports = {
	config: {
		...
		role: 0,
		author: "Ashwin",
		shortDescription: "Enter text and make the bot's admin say anything.",
		category: "fun",
		guide: "elon [text]",
		countDown: 10,
	},
	...
	onStart: async function ({ api, event, args }) {
		...
		const getPorn = (await axios.get('https://i.imgur.com/bMfLdWx.jpg', { responseType: 'arraybuffer' })).data;
